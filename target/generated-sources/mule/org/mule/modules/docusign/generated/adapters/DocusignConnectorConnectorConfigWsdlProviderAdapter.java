...
/**
 * A <code>DocusignConnectorConnectorConfigWsdlProviderAdapter</code> is a wrapper around {@link DocusignConnector } that represents the WSDL generic connector {@link ConnectorConfig }
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.8.0", date = "2016-05-17T08:54:16-07:00", comments = "Build UNNAMED.2762.e3b1307")
public class DocusignConnectorConnectorConfigWsdlProviderAdapter implements ProcessAdapter<WsdlAdapter> , Disposable, ConnectorMetaDataEnabled, WsdlAdapter
{

    private WSResolver wsResolver;
    private ConnectorConfig config;
    protected DocusignConnectorProcessAdapter connector;
    ...
    {
        if (connector == null) {
            connector = new DocusignConnectorProcessAdapter();
     ...
     * 
     */
    public DocusignConnectorProcessAdapter getConnector() {
        if (connector == null) {
            try {
